...
class AppDelegate: UIResponder, UIApplicationDelegate {
    ...
    func application(application: UIApplication, didFinishLaunchingWithOptions launchOptions: [NSObject: AnyObject]?) -> Bool {
        ...
        nowPlayingNavigationController.tabBarItem.image = UIImage (named: "np3")
        ...
        upcomingNavigationController.tabBarItem.image = UIImage (named: "up")
        ...
        topRatedNavigationController.tabBarItem.image = UIImage (named: "tr2")
